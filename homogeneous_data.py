...
class HomogeneousData():
    ...
    def __next__(self):
        ...
        # get the batch size
        #print self.len_curr_counts[self.len_unique[self.len_idx]], self.len_unique[self.len_idx], self.len_idx

        curr_batch_size = self.batch_size #numpy.minimum(self.batch_size, self.len_curr_counts[self.len_unique[self.len_idx]])        
